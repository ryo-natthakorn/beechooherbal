...
// URLs
// ---------------------------------------------------------------------------
// All 35 posts keep their legacy ROOT paths, Thai included. None of the /th/<slug>/
...
export const EVENT_PAIRS: { key: string; en: string; th: string }[] = [
  ...
  { key: "ayutthaya", en: "/grand-opening-of-new-outlet-bee-choo-ayutthaya/", th: "/grand-opening-บีชู-สาขาอยุธยา-ในวันท/" },
